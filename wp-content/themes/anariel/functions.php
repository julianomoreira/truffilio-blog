...
function anariel_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            'name'               => esc_html__('Revolution Slider','anariel'), // The plugin name.
        ...
        array(
            'name'               => esc_html__('Essential Grid','anariel'), // The plugin name.
            'slug'               => 'essential-grid', // The plugin slug (typically the folder name).
            'source'             => 'essgrid.zip', // The plugin source.
            'required'           => false, // If false, the plugin is only 'recommended' instead of required.
		...
		array(
				'name'      => esc_attr__('Clasic Editor','baltazar'),
