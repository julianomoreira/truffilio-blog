          ...
          if ( ! isset( $page['hidden_page'] ) && $screen->id == $this->page_hook[$page['id']] ) {
            ...
            echo '<div class="wrap settings-wrap" id ="page-' . $page['id'] . '">';
              ...
              echo '<h2>' . $theme->get( 'Name' ) .' '. $page['page_title'] . '</h2>';
				...
				We offer WordPress Maintenance services which are suitable for small blog sites or bigger corporation websites. Both basic and PRO versions include monthly backups, updates, and security checks. You will also receive dedicated support on a 24/7 basis (maximum response time is 24 hours) via our ticket system.
				<br><br>
				<a class="buy-freya button" title = "Click to check out the WordPress Maintenance services" href ="https://premiumcoding.com/wordpress-themes/wordpress-personal-support-maintenance/" target = "_blank">WordPress Maintenance services</a>
				</p>
				<p>
				<h2>Wordpress customization services</h2>
				We are an in-house team of web development and design experts. We can handle any customization and development that you might need.
				<br><br>
				<a class="buy-freya button" title = "Click to check out the Wordpress customization services" href ="https://premiumcoding.com/wordpress-themes/wordpress-theme-customization/" target = "_blank">Wordpress customization services</a>
				</p>	
				</div>
				<?php
